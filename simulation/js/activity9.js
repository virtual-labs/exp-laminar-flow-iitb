...
var ln_nu = [];
var c;
var a9_vals = []; // values of a and c;
var a9_fields_data = [0, 0, 0];
var table_4_current_ind = 0;
function activity9() {
    new_task("Calculate");
...
function table_for_regression() {
    let reg_tab = document.createElement("div");
    reg_tab.id = "reg-tab";
...
function cal_one() {
    ...
    let ans1 = document.getElementById("a9-f1");
    ans1.value = a9_vals[0].toString();
    let ans3 = document.getElementById("a9-f3");
