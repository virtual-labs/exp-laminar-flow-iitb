var actvity5_sel_data_ind: number = 0;
var selected_dia: number = 0.7;
var selected_outside_dia: number = 1;
var selected_shell_inside_dia: number = 1.8;
var selected_length: number = 100;
var selected_volume: number = 880;
var selected_flow_rate: number = 500;
...
function fill_inp1() {
	var inp1: HTMLSelectElement = <HTMLSelectElement>(
		document.getElementById('inp1')
	);
	inp1.innerHTML = ``;
	for (let i = 0; i < dia.length; i++) {
		var option: HTMLOptionElement = <HTMLOptionElement>(
...
function select_inp1_val() {
	let input1: HTMLSelectElement = <HTMLSelectElement>(
		document.getElementById('inp1')
	);

	let input2: HTMLSelectElement = <HTMLSelectElement>(
		document.getElementById('inp2')
	);
	input2.innerHTML = ``;

	let input3: HTMLSelectElement = <HTMLSelectElement>(
		document.getElementById('inp3')
	);
	input3.innerHTML = ``;

	let input4: HTMLSelectElement = <HTMLSelectElement>(
		document.getElementById('inp4')
	);
	input4.innerHTML = ``;

	let input5: HTMLSelectElement = <HTMLSelectElement>(
		document.getElementById('inp5')
	);
	input5.innerHTML = ``;

	let input6: HTMLSelectElement = <HTMLSelectElement>(
...
function a5_move_to_calculation() {
	...
	document.getElementById(
		'description-box'
	).innerText = `Calculation of the area based on the selected dimensions`;
	...
	console.log(
		selected_dia,
		selected_outside_dia,
		selected_shell_inside_dia,
		selected_length,
		selected_volume,
		selected_flow_rate
	);
...
<div id="tab2-box">
	...
	main.style.height = (
		((window.innerWidth * 0.97 * 1080.0) / 1920) *
		0.85
	).toString();
...
function a5_verify() {
	...
	let a1: HTMLInputElement = <HTMLInputElement>(
		document.getElementById('area-A')
	);
	let a2: HTMLInputElement = <HTMLInputElement>(
		document.getElementById('area-S')
	);
	let a3: HTMLInputElement = <HTMLInputElement>(
		document.getElementById('area-De')
	);
	let a4: HTMLInputElement = <HTMLInputElement>(
		document.getElementById('area-Sa')
	);
	...
	console.log(
		`answer  a=${heat_transfer_area}, s=${area_of_inner_tube}, de=${equivalent_diameter}, sa=${annulus_area},`
	);
