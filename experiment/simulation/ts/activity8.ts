...
var table_3: HTMLTableElement;

var table_3_ind: number = 1;

var a8_question_box: HTMLDivElement;

var show_exp_x: boolean = false;

var show_theo_x: boolean = false;

var show_y_axis: boolean = false;
...
function exp_x() {
    ...
    let all_x = document.querySelectorAll(".x-exp");
    all_x.forEach((element: Element) => {
        (element as HTMLElement).style.backgroundColor = "bisque";
    });
    show_exp_x = true;
}
