...
var a10_table = [];
var table_5_current_ind: number = 0;
var hi_pred: number[] = [];
var a10_count: number = 0;

var a10_hi_exp: number[] = [];
var a10_m: number[] = [];
var a10_re: number[] = [];
...
function plot10(a,c){
    ...
    let di: number = activity5_data[actvity5_sel_data_ind][0][0]/100;//from data set di was in cm to converted in m
    console.log("di = ", di);
