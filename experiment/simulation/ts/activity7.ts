...
var skip_ind: number[] = [];
var sel_physical_properties: number = 0;


var current_table_index: number = 0;

var table_input_1: HTMLInputElement;
var table_input_2: HTMLInputElement;
var table_input_3: HTMLInputElement;
var table_input_4: HTMLInputElement;
var table_input_5: HTMLInputElement;
var table_input_6: HTMLInputElement;
...
function activity7() {
   ...
   // new_score(global_score);
    ...
    let a7_form_one: HTMLDivElement = <HTMLDivElement> document.createElement("div");
...
function a7_verify_properties() {
    ...
    let h1: HTMLInputElement = <HTMLInputElement> document.getElementById('heat-capacity-input-1');
    let h2: HTMLInputElement = <HTMLInputElement>  document.getElementById('heat-capacity-input-2');

    let d1: HTMLInputElement =  <HTMLInputElement>  document.getElementById('density-input-1');
    let d2: HTMLInputElement =  <HTMLInputElement>  document.getElementById('density-input-2');

    let v1: HTMLInputElement =  <HTMLInputElement>  document.getElementById('viscosity-input-1');
    let v2: HTMLInputElement =  <HTMLInputElement>  document.getElementById('viscosity-input-2');

    let k1: HTMLInputElement =  <HTMLInputElement>  document.getElementById('thermal-conductivity-input-1');
    let k2: HTMLInputElement =  <HTMLInputElement>  document.getElementById('thermal-conductivity-input-2');
...
function check_properties_error(ans:number, calculated: number) {
...
function verify_main_table() {
    ...
    let inp1 = parseFloat(table_input_1.value)*(10**(-5));
    let inp2 =  parseFloat(table_input_2.value)*(10**(-3));
    let inp3 =  parseFloat(table_input_3.value)*(10**(-3));
...
function check_main_table_error(ans:number, calculated: number) {
    let res = Math.abs(((ans - calculated) / ans) * 100);
    console.log(res);
...
function build_table() {
    ...
    let inp4: HTMLInputElement = <HTMLInputElement> document.createElement("input");
    inp4.style.width = "100%";
    table_input_4 = inp4;
    

    let inp5: HTMLInputElement = <HTMLInputElement> document.createElement("input");
    inp5.style.width = "100%";
    table_input_5 = inp5;
    

    let inp6: HTMLInputElement = <HTMLInputElement> document.createElement("input");
...
function complete_table() {
    ...
    for(let i=1; i<readings[observation_data_index].reading.length; i++) {
        ...
        let td_6 = document.createElement('td');
        td_6.innerText = `${(res[0]/(10**(-5))).toFixed(2)}`;
        let td_7 = document.createElement('td');
        td_7.innerText = `${(res[1]/(10**(-3))).toFixed(2)}`;
        let td_8 = document.createElement('td');
        td_8.innerText = `${(res[2]/(10**(-3))).toFixed(2)}`;
...
function a7_check_calculation() {
    ...
    let f1: HTMLInputElement = <HTMLInputElement> document.getElementById('a7-f1');
    let f2: HTMLInputElement = <HTMLInputElement> document.getElementById('a7-f2');
    let f3: HTMLInputElement = <HTMLInputElement> document.getElementById('a7-f3');
    let f4: HTMLInputElement = <HTMLInputElement> document.getElementById('a7-f4');
    let f5: HTMLInputElement = <HTMLInputElement> document.getElementById('a7-f5');
    let f6: HTMLInputElement = <HTMLInputElement> document.getElementById('a7-f6');
...
function a7_add_table_2() {
    ...
    let new_fields: HTMLDivElement = <HTMLDivElement> document.createElement("div");
...
function show_table_2() {
    ...
    let tbody = document.getElementById('tb-2-tbody');
        ...
        let inp2 : HTMLInputElement = <HTMLInputElement> document.createElement("input");
        let inp3 : HTMLInputElement = <HTMLInputElement> document.createElement("input");
        let inp4 : HTMLButtonElement = <HTMLButtonElement> document.createElement("button");
