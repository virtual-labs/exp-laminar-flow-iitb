...
function verify_readings() {
    ...
    let inp1: HTMLInputElement = <HTMLInputElement> document.getElementById("table-0-inp1");

    let inp2: HTMLInputElement = <HTMLInputElement> document.getElementById("table-0-inp2");

    let inp3: HTMLInputElement = <HTMLInputElement> document.getElementById("table-0-inp3");

    let inp4: HTMLInputElement = <HTMLInputElement> document.getElementById("table-0-inp4");

    let inp5: HTMLInputElement = <HTMLInputElement> document.getElementById("table-0-inp5");
