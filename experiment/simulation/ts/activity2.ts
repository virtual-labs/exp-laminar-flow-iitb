...
var compare_img_one: HTMLImageElement = <HTMLImageElement> document.createElement("img");
...
var compare_img_two: HTMLImageElement = <HTMLImageElement> document.createElement("img");
compare_img_two.id = "comp_flow_2";
compare_img_two.src = "./images/laminar_flow.gif";

var questions: string[] = [];
var ques_number: number = 0;
...
function load_question(question: string, num: string) {
...
function check_answers_1 (str: string) {
    ...
    let op: string = '';
    let rb1: HTMLInputElement = <HTMLInputElement>  document.getElementById('a2op1');
    let rb2: HTMLInputElement = <HTMLInputElement>  document.getElementById('a2op2');
    let rb3: HTMLInputElement = <HTMLInputElement>  document.getElementById('a2op3');
    let rb4: HTMLInputElement = <HTMLInputElement>  document.getElementById('a2op4');
